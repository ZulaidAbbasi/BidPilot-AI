...
export default defineTool({
  ...
  inputSchema: {
    limit: z.number().int().min(1).max(100).optional().describe("Max negotiations to return (default 25)."),
    status: z.string().optional().describe("Optional workflow_status filter, e.g. DRAFT, IN_NEGOTIATION."),
  },
