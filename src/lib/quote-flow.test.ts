...
describe("$1,500 → $1,350 negotiation flow", () => {
  ...
  it("reconciles baseline=1500, final=1350, savings=150 across the three snapshots", () => {
    const quotes = [
      { id: "q1", quote_stage: "INITIAL", total_amount: 1500, terms: null, captured_at: "2026-07-19T10:00:00Z" },
      { id: "q2", quote_stage: "REVISED", total_amount: 1500, terms: null, captured_at: "2026-07-19T10:01:00Z" },
      { id: "q3", quote_stage: "FINAL", total_amount: 1350, terms: null, captured_at: "2026-07-19T10:02:00Z" },
    ];
    const transcripts = [
      { id: "t1", text: "The total will be one thousand five hundred dollars.", sequence_number: 1, started_at_ms: 1000 },
      { id: "t2", text: "Okay, I can bring it down to thirteen hundred fifty for the whole job, that's the final offer.", sequence_number: 2, started_at_ms: 2000 },
    ];
    const rec = reconcile(quotes as any, {}, transcripts as any);
  ...
  it("still finds baseline=1500 when the anomalous $500 INITIAL is present", () => {
    const quotes = [
      { id: "q0", quote_stage: "INITIAL", total_amount: 500, terms: null, captured_at: "2026-07-19T09:59:00Z" },
      { id: "q1", quote_stage: "REVISED", total_amount: 1500, terms: null, captured_at: "2026-07-19T10:00:00Z" },
      { id: "q2", quote_stage: "FINAL", total_amount: 1350, terms: null, captured_at: "2026-07-19T10:02:00Z" },
    ];
    const rec = reconcile(quotes as any, {}, []);
    expect(rec.initialTotal).toBe(1500);
    expect(rec.finalTotal).toBe(1350);
  });
});
