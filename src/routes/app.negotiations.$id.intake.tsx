      ...
      <div className="space-y-6">
        <Card>
          ...
          <CardContent className="space-y-3 text-sm text-muted-foreground">
            <p>
              Populate the canonical specification from any combination of manual entry,
              a document upload, or a voice intake session. Every source writes into the
              same draft — you always review and confirm before providers see it.
            </p>
            <div className="flex flex-wrap gap-2">
              ...
              <Button asChild variant="outline" size="sm" disabled>
                <span>
                  <MicVocal className="mr-1.5 h-3.5 w-3.5" /> Voice intake — coming soon
                </span>
              </Button>
            </div>
          </CardContent>
